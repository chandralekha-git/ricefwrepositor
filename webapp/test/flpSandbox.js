		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RICEFW Estimator",
									"targetURL": "#ricefwestimator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ricefwestimator-display": {
								"semanticObject": "ricefwestimator",
								"action": "display",
								"description": "RICEFW Estimator",
								"title": "RICEFW Estimator",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ricefwestimator",
									"url": sap.ui.require.toUrl("ricefwestimator")
								}
							}
						}
					}
